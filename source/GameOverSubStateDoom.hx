...
class GameOverSubstateDoom extends MusicBeatSubstate
{
	...
	public static var instance:GameOverSubstateDoom;
	...
	public function new(x:Float, y:Float, camX:Float, camY:Float)
	{
		...
		var background:FlxSprite = new FlxSprite().makeGraphic(FlxG.width * 4, FlxG.height * 4, FlxColor.WHITE);
		background.screenCenter();
		if (PlayState.SONG.stage == 'sky')add(background);
